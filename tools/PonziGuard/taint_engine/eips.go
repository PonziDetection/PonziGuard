...
func opSelfBalance(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, []int, error) {
...
func opChainID(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, []int, error) {
...
func opBaseFee(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, []int, error) {
