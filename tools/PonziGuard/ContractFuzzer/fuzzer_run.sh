...
echo ${CONTRACT_DIR}
~/Downloads/ContractFuzzer-master/contract_fuzzer/src/ContractFuzzer/contractfuzzer/contract_fuzzer -abi_dir ${CONTRACT_DIR}/verified_contract_abis     \
  ...
  -tester_port   http://localhost:8088/               \
  -listen_port   :8888                                \
  -abi_dir       ${CONTRACT_DIR}/verified_contract_abis        \
  -out_dir       ${CONTRACT_DIR}/verified_contract_abis_fuzz
